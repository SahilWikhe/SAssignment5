...
def create(db: Session, sandwich):
    ...
    db_sandwich = models.Sandwich(
        ...
        price=sandwich.price  # Assuming these fields exist in your Sandwich model
    )
...
def read_all(db: Session):
    # Query the database to get all sandwich records
    return db.query(models.Sandwich).all()

def read_one(db: Session, sandwich_id):
    # Query the database for a specific sandwich by ID
